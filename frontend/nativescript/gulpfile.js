...
gulp.task('phone.Typescript', () => {
    return (
        gulp
            .src([`${SRC}**/*.tns.phone.ts`], { follow: true })
            .pipe(rename(removeTns))
    ...
    return (
        gulp
            .src(
                [
                    `${SRC}**/*.tns.phone.html`,
                    `${SRC}**/*.tns.ios.phone.html`,
                    `${SRC}**/*.tns.android.phone.html`
                ],
                { follow: true }
            )
            .pipe(rename(removeTns))
    ...
    return (
        gulp
            .src(
                [
                    `${SRC}**/*.tns.phone.scss`,
                    `${SRC}**/*.tns.ios.phone.scss`,
                    `${SRC}**/*.tns.android.phone.scss`
                ],
                { follow: true }
            )
            .pipe(rename(removeTns))
...
gulp.task('tns.ComponentStyles', () => {
    return (
        gulp
            .src([`${DEST}/**/*.component.ts`], { follow: true })
...
gulp.task(
    'build.cli.Default',
    gulp.series('build.Default', 'tns.ComponentStyles')
);

gulp.task('build.cli.Phone', gulp.series('build.Phone', 'tns.ComponentStyles'));
