...
//   companyName: 'BenvanHeerden',
//   submitURL: 'https://github.com/benshez/geo-services',
//   autoSubmit: true
// });
...
app.on('ready', () => {
	...
	let helpMenu: any = {
		...
		submenu: [{
			label: 'Learn More',
			click: () => {
				shell.openExternal('https://github.com/benshez/geo-services');
			}
		}, {
			label: 'Issues',
			click: () => {
				shell.openExternal('https://github.com/benshez/geo-services/issues');
			}
		}, {
			...
			click: () => {
				shell.openExternal('http://codeology.braintreepayments.com/BenvanHeerden/geoservice');
			}
		}]
	};
