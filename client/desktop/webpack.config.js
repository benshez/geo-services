...
const entryPoints = ['inline', 'polyfills', 'style', 'vendor', 'app'];
...
module.exports = function (options, webpackOptions) {
	...
	config = webpackMerge({}, config, {
		...
		plugins: [
			new html({
				template: root('../shared/src/public/index.html'),
				output: root('build'),
...
function getEntry(options) {
	if (options.aot) {
		...
		return {
			app: root('src/main.ts'),
			polyfills: root('../shared/src/polyfills.ts')
		};
	}
}
