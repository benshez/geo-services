...
export class SeedAdvancedConfig extends SeedConfig {
  ...
  constructor() {
    ...
    this.BOOTSTRAP_FACTORY_PROD_MODULE = `${this
      .BOOTSTRAP_DIR}${bootstrap}.prod`;

    this.APP_TITLE = 'Geo Service';
    this.APP_BASE = this.TARGET_DESKTOP
      ? '' // paths must remain relative for desktop build
      : '/';
    ...
    let additionalPackages: ExtendPackages[] = [
      ...
      },
      {
        ...
        path: 'node_modules/ngx-auto-unsubscribe/dist/index.js',
        packageMeta: {
          main: 'index.js',
          defaultExtension: 'js'
        }
    ...
    /**
         ...
         */
    this.DESKTOP_PACKAGES = [...this.DESKTOP_PACKAGES, ...additionalPackages];
    ...
    this.SYSTEM_CONFIG.paths[this.BOOTSTRAP_MODULE] = `${this.APP_BASE}${this
      .BOOTSTRAP_MODULE}`;
