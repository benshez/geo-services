...
class Locations
{
	...
	/**
		...
		*
		* @ORM\ManyToOne(targetEntity="GeoService\Users\Entity\Users")
		* @ORM\JoinColumns({
	...
	/**
		* Set user
		*
		* @param \GeoService\Users\Entity\Users $user
		*
		* @return Locations
		*/
	public function setUser(\GeoService\Users\Entity\Users $user = null)
	{
			$this->user = $user;
