...
class Users
{
	...
	/**
		* @var \GeoService\Industries\Entity\Industries
		*
		* @ORM\ManyToOne(targetEntity="\GeoService\Industries\Entity\Industries")
		* @ORM\JoinColumns({
	...
	/**
		* Set industry
		*
		* @param \GeoService\Industries\Entity\Industries $industry
		*
		* @return Users
		*/
	public function setIndustry(\GeoService\Industries\Entity\Industries $industry = null)
	{
