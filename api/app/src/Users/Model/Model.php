...
namespace GeoService\Users\Model;

use Interop\Container\ContainerInterface;
use Psr\Http\Message\RequestInterface;
use Psr\Http\Message\ResponseInterface;
use GeoService\Users\Interfaces\IUsersModel;
...
class Model extends BaseModel implements IUsersModel
{
	...
	public function authenticate($email, $password)
	{
		...
		$this->setCriteria(array(\GeoService\Base\BaseConstants::$FIND_BY_ONE_KEY_EMAIL => $email));
