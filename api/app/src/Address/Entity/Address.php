 ...
 * @ORM\Entity
 * @ORM\Entity(repositoryClass="GeoService\Address\Entity\Repository")
 */
...
class Address {
     ...
     *
     * @ORM\OneToOne(targetEntity="\GeoService\Users\Entity\Users")
     * @ORM\JoinColumns({
     ...
     * Set id
     *
     * @param \GeoService\Users\Entity\Users $id
     *
     * @return Address
     */
    public function setId(\GeoService\Users\Entity\Users $id = null)
    {
        $this->id = $id;
     ...
     * Get id
     *
     * @return \GeoService\Users\Entity\Users
     */
